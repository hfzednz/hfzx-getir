...
const (
	...
	EventGeofenceEnter   = "GeofenceEnter"
	EventGeofenceExit    = "GeofenceExit"
	EventArrived         = "Arrived"

	TopicTrackingLocation = "tracking.location"
	TopicTrackingGeofence = "tracking.geofence"
	TopicTrackingTimeline = "tracking.timeline"
)
...
func TopicForEvent(eventType string) string {
	...
	case EventLocationUpdated:
		return TopicTrackingLocation
	case EventGeofenceEnter, EventGeofenceExit:
		return TopicTrackingGeofence
	case EventArrived:
		return TopicTrackingTimeline
	default:
		return TopicTrackingLocation
	}
}
