...
type Deps struct {
	Deployments ports.DeploymentRepo
	Scaling     ports.ScalingRepo
	Backups     ports.BackupRepo
	Recoveries  ports.RecoveryRepo
	Alerts      ports.AlertRepo
	Costs       ports.CostRepo
	SLOs        ports.SLORepo
	Outbox      ports.OutboxRepository
	Publisher   ports.EventPublisher
	GitOps      ports.GitOpsClient
