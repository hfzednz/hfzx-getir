...
type Deps struct {
	Modules      ports.ModuleRepo
	Experiments  ports.ExperimentRepo
	Simulations  ports.SimulationRepo
	Twins        ports.TwinRepo
	Edge         ports.EdgeRepo
	IoT          ports.IoTRepo
	Robots       ports.RobotRepo
	Assignments  ports.AssignmentRepo
	Drones       ports.DroneRepo
	Blockchain   ports.BlockchainRepo
	XR           ports.XRRepo
	Multimodal   ports.MultimodalRepo
	Green        ports.GreenRepo
	Quantum      ports.QuantumRepo
