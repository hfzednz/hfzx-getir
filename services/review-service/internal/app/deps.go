...
// Deps aggregates application ports for review use cases.
type Deps struct {
	Reviews     ports.ReviewRepo
	Ratings     ports.RatingRepo
	Media       ports.MediaRepo
	Interactions ports.InteractionRepo
	Quality     ports.QualityRepo
	Moderation  ports.ModerationRepo
	Trust       ports.TrustRepo
	Reputation  ports.ReputationRepo
	Outbox      ports.OutboxRepository
	Orders      ports.OrderReadClient
	MediaClient ports.MediaClient
	AI          ports.ModerationClient
