...
type Deps struct {
	Suppliers   ports.SupplierRepo
	Documents   ports.DocumentRepo
	Certs       ports.CertRepo
	Contracts   ports.ContractRepo
	RFQs        ports.RFQRepo
	Quotes      ports.QuotationRepo
	POs         ports.PORepo
	Shipments   ports.ShipmentRepo
	Invoices    ports.InvoiceMatchRepo
	Sellers     ports.SellerRepo
	Listings    ports.ListingRepo
	Submissions ports.SubmissionRepo
	EDI         ports.EDIRepo
	Scorecards  ports.ScorecardRepo
	Messages    ports.MessageRepo
	Changes     ports.ChangeRepo
	Outbox      ports.OutboxRepository
	Publisher   ports.EventPublisher
	ERP         ports.ERPClient
	Catalog     ports.CatalogClient
	Inventory   ports.InventoryClient
	Settlement  ports.SettlementClient
	AI          ports.AIClient
