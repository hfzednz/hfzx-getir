...
type Deps struct {
	...
	Weaknesses   ports.WeaknessRepo
	Heals        ports.HealRepo
	Reviews      ports.ReviewRepo
	Evolution    ports.EvolutionRepo
	Releases     ports.ReleaseRepo
	Governance   ports.GovernanceRepo
	Assistants   ports.AssistantRepo
	Teams        ports.TeamRepo
	Dependencies ports.DependencyRepo
	Genesis      ports.GenesisRepo
	Outbox       ports.OutboxRepository
	Publisher    ports.EventPublisher
	Hyperscale   ports.HyperscaleClient
	PlatformOps  ports.PlatformOpsClient
	Quality      ports.QualityClient
	Security     ports.SecurityClient
	LiveOps      ports.LiveOpsClient
