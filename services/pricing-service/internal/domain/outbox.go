...
const (
	...
	EventQuoteCreated = "QuoteCreated"

	TopicPricingPrice = "pricing.price"
	TopicPricingQuote = "pricing.quote"
)
...
func TopicForEvent(eventType string) string {
	...
	case EventPriceChanged:
		return TopicPricingPrice
	case EventQuoteCreated:
		return TopicPricingQuote
	default:
		return TopicPricingPrice
	}
}
