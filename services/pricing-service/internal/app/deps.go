...
// Deps aggregates application ports for pricing use cases.
type Deps struct {
	Prices   ports.PriceRepo
	Taxes    ports.TaxRepo
	Dynamics ports.DynamicRepo
	Audits   ports.QuoteAuditRepo
	Outbox   ports.OutboxRepository
	Promo    ports.PromoClient
	Hints    ports.DynamicHintClient
