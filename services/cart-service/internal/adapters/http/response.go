...
func mapError(err error) (code string, status int, retriable bool, message string) {
	...
	message = err.Error()
	switch {
	case errors.Is(err, domain.ErrNotFound), errors.Is(err, domain.ErrCouponNotApplied):
	...
	case errors.Is(err, domain.ErrInvalidArgument), errors.Is(err, domain.ErrNegativeMoney),
		errors.Is(err, domain.ErrCurrencyMismatch), errors.Is(err, domain.ErrOwnerRequired),
		errors.Is(err, domain.ErrCouponInvalid), errors.Is(err, domain.ErrEmptyCart),
		errors.Is(err, domain.ErrMaxQtyExceeded):
	...
	case errors.Is(err, domain.ErrInvalidTransition), errors.Is(err, domain.ErrCartInactive):
