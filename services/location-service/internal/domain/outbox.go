...
const (
	EventAddressValidated = "AddressValidated"
	EventAddressCreated   = "AddressCreated"
	EventLocationUpdated  = "LocationUpdated"
	EventRouteCalculated  = "RouteCalculated"
	EventETAUpdated       = "ETAUpdated"
	EventGeofenceEntered  = "GeofenceEntered"
	EventGeofenceExited   = "GeofenceExited"
	EventDeliveryZoneChanged = "DeliveryZoneChanged"

	TopicLocationAddress  = "location.address"
	TopicLocationGeo      = "location.geo"
	TopicLocationGeofence = "location.geofence"
	TopicLocationZone     = "location.zone"
)
...
func TopicForEvent(eventType string) string {
	switch eventType {
	case EventAddressValidated, EventAddressCreated:
		return TopicLocationAddress
	case EventLocationUpdated, EventRouteCalculated, EventETAUpdated:
		return TopicLocationGeo
	case EventGeofenceEntered, EventGeofenceExited:
		return TopicLocationGeofence
	case EventDeliveryZoneChanged:
		return TopicLocationZone
	default:
		return TopicLocationGeo
	}
}
