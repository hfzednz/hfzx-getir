...
// Deps aggregates application ports for location use cases.
type Deps struct {
	Addresses ports.AddressRepo
	POIs      ports.POIRepo
	History   ports.HistoryRepo
	Cache     ports.CacheRepo
	Heat      ports.HeatRepo
	Outbox    ports.OutboxRepository
	Maps      ports.MapsProvider
	Geofence  ports.GeofenceClient
	Routing   ports.RoutingClient
	Search    ports.GeoSearchIndexer
