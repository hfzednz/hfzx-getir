...
type Deps struct {
	Countries    ports.CountryRepo
	Places       ports.PlaceRepo
	Languages    ports.LanguageRepo
	Locales      ports.LocaleRepo
	Translations ports.TranslationRepo
	Currencies   ports.CurrencyRepo
	Rates        ports.RateRepo
	Holidays     ports.HolidayRepo
	Rules        ports.RuleRepo
	Taxes        ports.TaxRepo
	Privacy      ports.PrivacyRepo
	PayAvail     ports.PayAvailRepo
	Logistics    ports.LogisticsRepo
	Legal        ports.LegalRepo
	Outbox       ports.OutboxRepository
	Publisher    ports.EventPublisher
	FX           ports.FXClient
	AI           ports.AITranslateClient
