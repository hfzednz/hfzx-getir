...
type Deps struct {
	Suites     ports.SuiteRepo
	Runs       ports.RunRepo
	Results    ports.ResultRepo
	Coverage   ports.CoverageRepo
	Policies   ports.PolicyRepo
	Evals      ports.EvalRepo
	Certs      ports.CertRepo
	Flaky      ports.FlakyRepo
	Perf       ports.PerfRepo
	Security   ports.SecurityRepo
	Outbox     ports.OutboxRepository
	Publisher  ports.EventPublisher
	Runner     ports.RunnerClient
