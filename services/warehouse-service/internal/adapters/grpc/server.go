// Package grpcadapter provides a gRPC server stub for warehouse v1.
package grpcadapter
...
func (s *Server) ListenAndServe() error {
	...
	s.ln = ln
	s.cfg.Log.Info("grpc.stub.listen", "addr", s.cfg.Addr, "note", "wire proto/warehouse/v1 after protoc")
	for {
		conn, err := ln.Accept()
		if err != nil {
			return err
