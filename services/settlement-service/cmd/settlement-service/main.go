...
import (
	...
	httpadapter "github.com/nexora/settlement-service/internal/adapters/http"
	"github.com/nexora/settlement-service/internal/adapters/kafka"
	"github.com/nexora/settlement-service/internal/adapters/ledger"
	"github.com/nexora/settlement-service/internal/adapters/payout"
	"github.com/nexora/settlement-service/internal/adapters/postgres"
	"github.com/nexora/settlement-service/internal/adapters/redis"
	"github.com/nexora/settlement-service/internal/app"
	"github.com/nexora/settlement-service/internal/app/memory"
	"github.com/nexora/settlement-service/internal/config"
...
func main() {
	...
	deps := &app.Deps{
		...
		Ledger:    ledger.NewClient(cfg.LedgerBaseURL, log),
		Payout:    payout.NewClient(cfg.PayoutProviderURL, log),
