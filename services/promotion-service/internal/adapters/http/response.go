...
func mapError(err error) (code string, status int, retriable bool, message string) {
	...
	case errors.Is(err, domain.ErrInvalidArgument), errors.Is(err, domain.ErrNegativeMoney),
		errors.Is(err, domain.ErrCurrencyMismatch), errors.Is(err, domain.ErrCouponInvalid),
		errors.Is(err, domain.ErrVoucherInvalid), errors.Is(err, domain.ErrNotEligible):
	...
	case errors.Is(err, domain.ErrConflict), errors.Is(err, domain.ErrVersionConflict),
		errors.Is(err, domain.ErrCouponRedeemed), errors.Is(err, domain.ErrCouponExhausted),
		errors.Is(err, domain.ErrVoucherExhausted), errors.Is(err, domain.ErrUsageLimit):
		return "conflict", http.StatusConflict, false, message
	case errors.Is(err, domain.ErrInvalidTransition), errors.Is(err, domain.ErrCampaignInactive):
