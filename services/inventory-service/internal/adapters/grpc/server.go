// Package grpcadapter provides a gRPC server stub for inventory v1.
package grpcadapter
...
func (s *Server) ListenAndServe() error {
	...
	s.ln = ln
	s.cfg.Log.Info("grpc.stub.listen", "addr", s.cfg.Addr, "note", "wire proto/inventory/v1 after protoc")
	for {
		conn, err := ln.Accept()
		if err != nil {
			return err
