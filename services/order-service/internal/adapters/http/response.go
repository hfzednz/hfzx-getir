...
func mapError(err error) (code string, status int, retriable bool, message string) {
	...
	case errors.Is(err, domain.ErrInvalidTransition),
		errors.Is(err, domain.ErrCancelNotAllowed),
		errors.Is(err, domain.ErrModifyNotAllowed),
		errors.Is(err, domain.ErrReturnNotAllowed),
		errors.Is(err, domain.ErrRefundNotAllowed):
