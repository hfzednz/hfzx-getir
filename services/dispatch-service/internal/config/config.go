...
// Config is the runtime configuration for dispatch-service.
type Config struct {
	HTTPAddr           string
	GRPCAddr           string
...
func Load() (Config, error) {
	cfg := Config{
		...
		GRPCAddr:           env("GRPC_ADDR", ":9106"),
		PublicBaseURL:      strings.TrimRight(env("PUBLIC_BASE_URL", "http://localhost:8096"), "/"),
