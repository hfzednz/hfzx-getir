...
const (
	EventDispatchCreated    = "DispatchCreated"
	EventCourierAssigned    = "CourierAssigned"
	EventCourierReassigned  = "CourierReassigned"
	EventPickupStarted      = "PickupStarted"
	EventPickupCompleted    = "PickupCompleted"
	EventDeliveryStarted    = "DeliveryStarted"
	EventDeliveryArrived    = "DeliveryArrived"
	EventDeliveryCompleted  = "DeliveryCompleted"
	EventDeliveryFailed     = "DeliveryFailed"

	TopicDispatchJob        = "dispatch.job"
	TopicDispatchAssignment = "dispatch.assignment"
)
...
func TopicForEvent(eventType string) string {
	switch eventType {
	case EventCourierAssigned, EventCourierReassigned:
		return TopicDispatchAssignment
	default:
		return TopicDispatchJob
	}
}
