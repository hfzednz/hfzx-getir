...
type Deps struct {
	...
	Manifests     ports.ManifestRepo
	Installs      ports.InstallRepo
	Permissions   ports.PermissionRepo
	Listings      ports.ListingRepo
	Ratings       ports.RatingRepo
	Widgets       ports.WidgetRepo
	Monetization  ports.MonetizationRepo
	Launches      ports.LaunchRepo
