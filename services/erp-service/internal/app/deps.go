...
type Deps struct {
	...
	Periods     ports.PeriodRepo
	Accounts    ports.AccountRepo
	Journals    ports.JournalRepo
	Suppliers   ports.SupplierRepo
	Procurement ports.ProcurementRepo
	AP          ports.APRepo
	AR          ports.ARRepo
	Treasury    ports.TreasuryRepo
	Budgets     ports.BudgetRepo
	Assets      ports.AssetRepo
	Tax         ports.TaxRepo
	Expenses    ports.ExpenseRepo
	Approvals   ports.ApprovalRepo
	Payroll     ports.PayrollRepo
