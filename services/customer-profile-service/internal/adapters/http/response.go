...
// APIError is the NEXORA error envelope (camelCase).
...
func writeErr(w http.ResponseWriter, r *http.Request, err error) {
	observability.Default.HTTPErrors.Add(1)
