...
type Deps struct {
	...
	Synonyms  ports.SynonymRepo
	Boosts    ports.BoostRepo
	Jobs      ports.IndexJobRepo
	Trends    ports.TrendRepo
	Suggests  ports.SuggestRepo
	Outbox    ports.OutboxRepository
	Lexical   ports.LexicalIndex
	Vectors   ports.VectorStore
	Embed     ports.EmbeddingClient
	LLM       ports.LLMClient
	Catalog   ports.CatalogReadClient
	Inventory ports.InventoryClient
	Pricing   ports.PricingClient
	Reviews   ports.ReviewClient
	Recs      ports.RecommendationClient
