...
| https://github.com/hfzednz/hfzx-getir/actions/runs/32901244234 | FAIL (partial) | Recovery PASS. UI: nested `@nexora/ui` missing `clsx`. Journeys: payment eligibility 400 because BFF sent unknown JSON field `method`. |
