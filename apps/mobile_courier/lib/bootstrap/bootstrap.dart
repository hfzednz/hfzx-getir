...
import '../app/nexora_courier_app.dart';
...
Future<BootstrapResult> bootstrap() async {
  ...
  final localStore = await CourierLocalStore.open(path: appDir.path);
  ...
  final overrides = <Override>[
    ...
    courierLocalStoreProvider.overrideWithValue(localStore),
  ];
...
Future<void> runNexoraCourierApp(BootstrapResult bootstrap) async {
  runApp(
    ProviderScope(
      overrides: bootstrap.overrides,
      child: const NexoraCourierApp(),
    ),
  );
}
