...
import { TenantContextSwitcher } from "./tenant-context-switcher";
...
/** Platform shell — Super Admin chrome (not city-ops AdminShell). */
        ...
        <TopBar
          leading={
            <>
              ...
              <span className="hidden lg:inline text-[12px] font-semibold tracking-[-0.01em] text-[var(--nx-brand-700)] whitespace-nowrap">
                NEXORA Super Admin
              </span>
